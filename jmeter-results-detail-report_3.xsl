...
<xsl:template name="summary">
	<h2>Summary</h2>
	<table class="details" border="0" cellpadding="5" cellspacing="2" width="1000px">
		<tr valign="top">
			<th>Tests</th>
			<th>Failures</th>
			<th>Success Rate</th>
			...
			<xsl:if test="$failureCount > 0">
				...
				<xsl:for-each select="/testResults/*[@lb = current()/@lb][attribute::s='false']">
					...
					<tr valign="top">
					    ...
					    <th width="10%">Request Header</th>
					    <th width="40%">Request URL</th>
					    <th width="40%">QueryString</th>
					</tr>
					<tr>
						<td><xsl:value-of select="method" /></td>
						<td><xsl:value-of select="requestHeader" /></td>
						<td><b><xsl:value-of select="java.net.URL" /></b></td>
						<td><xsl:value-of select="queryString" /></td>
					</tr>
					<tr valign="top">
					    <th colspan="4">Response Data</th>
					</tr>
					<tr>
					    <xsl:variable name="valueLength" select="string-length(responseData)"/>
						<td colspan="4"><xsl:value-of select="substring(responseData,0,200)"/><xsl:if test="$valueLength > 200">......</xsl:if></td>
					</tr>
				</xsl:for-each>
